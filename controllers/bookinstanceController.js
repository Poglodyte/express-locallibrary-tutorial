...
exports.bookinstance_delete_get = function(req, res) {
  ...
  // Any reason to get the BookInstance?
  // Shouldn't need to display it again, since no references to BookInstance

  // Still want to display the details on delete confirmation page though
...
exports.bookinstance_delete_post = function(req, res, next) {
  ...
  // No need to check for references, so just attempt to delete?
  BookInstance.findByIdAndRemove(req.body.bookinstanceid, function deleteBookInstance(err) {
    if (err) { return next(err); }
    // else, success - go to book instances list
...
exports.bookinstance_update_get = function(req, res, next) {
  ...
  // Need to get current book instance record to display in form
  // and get books available for selection in instance creation
  async.parallel(
    {
